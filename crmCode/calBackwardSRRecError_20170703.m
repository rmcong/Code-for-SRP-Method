...
fg_sp_intra = extract_fg_sp(backframe_sup.intra,0.5*options.fg_num);%factor是尺度因子，即从总超像素个数中选择前factor%个超像素做前景种子点
fg_sp_forward = extract_fg_sp(backframe_sup.forward,0.5*options.fg_num);%factor是尺度因子，即从总超像素个数中选择前factor%个超像素做前景种子点
