function [ SRRecError, propSRRecError ] = calIntraSRRecError( options, frameName, Label, bg_sp, of_sup,  MOF_sup )
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% 利用稀疏重建误差提取显著性区域 2017/06/28 使用29维特征表示超像素特性 RGB Lab HSV texton（15） x y motion(3)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
feat = extractSupfeatnew(options, frameName, sulabel, regions, of_sup,  MOF_sup);
featDim = size(feat,2);
