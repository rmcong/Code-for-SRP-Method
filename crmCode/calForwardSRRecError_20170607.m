function [ ForSRRecError, propForSRRecError ] = calForwardSRRecError_20170607( options, curframe_sup, preframe_sup, ismot )
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
fg_sp = extract_fg_sp(preframe_sup.intra,options.Forfactor);%factor是尺度因子，即从总超像素个数中选择前10%个超像素做前景种子点
