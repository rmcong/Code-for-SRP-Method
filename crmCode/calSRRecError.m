function [ SRRecError, propSRRecError ] = calSRRecError( options, frameName, Label )
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% 利用稀疏重建误差提取显著性区域 2017/05/23 使用26维特征表示超像素特性 RGB Lab HSV texton（15） x y
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
bg_sp = extract_bg_sp(sulabel,r,c);%选择上下左右四个边的超像素区域作为背景超像素
bgfeat = feat(bg_sp,:);
